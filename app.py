...
# Creazione del file Python aggiornato con i due grafici distinti (economico e CO₂)
...
if anni_pareggio:
    ...
    fig1, ax1 = plt.subplots(figsize=(8, 5))
    ax1.plot(anni, costi_risparmiati, label="Risparmio economico (€)", color="blue", marker="o", linestyle="-")
    ax1.set_xlabel("Anni di utilizzo")
    ax1.set_ylabel("Risparmio economico (€)", color="blue")
    ax1.tick_params(axis="y", labelcolor="blue")
    plt.title("Tempo di ritorno dell'investimento economico")
...
if anni_pareggio:
    ...
    fig2, ax2 = plt.subplots(figsize=(8, 5))
    ax2.plot(anni, co2_risparmiata_totale, label="CO₂ risparmiata (kg)", color="green", marker="s", linestyle="--")
    ax2.set_xlabel("Anni di utilizzo")
    ax2.set_ylabel("CO₂ risparmiata (kg)", color="green")
    ax2.tick_params(axis="y", labelcolor="green")
    plt.title("Tempo di ritorno dell'investimento in CO₂")
